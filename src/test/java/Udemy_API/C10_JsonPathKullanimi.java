...
public class C10_JsonPathKullanimi {
    ...
    public void method1(){
        ...
        kisiBilgileriJsonObj.put("phoneNumber",telefonBilgileriArr);

        System.out.println(kisiBilgileriJsonObj);
        System.out.println("firstName : "+kisiBilgileriJsonObj.get("firstName"));
        System.out.println("laststName : "+kisiBilgileriJsonObj.get("lastName"));
        ...
        System.out.println("cep tel no : "+ kisiBilgileriJsonObj.getJSONArray("phoneNumber")
                .getJSONObject(0)
                .get("number"));
